import s from './FindUserBtn.module.scss';

export const FindUserBtn = (props: React.ComponentPropsWithRef<'button'>): React.ReactElement => {
  return (
    <button {...props} type='submit' className={s.findUserBtn}>
      <svg
        fill='#41525d'
        height='30px'
        width='30px'
